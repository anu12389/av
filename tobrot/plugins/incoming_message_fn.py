...
async def incoming_message_f(client, message):
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text(
            "Use This Command As Reply To a <u>Direct Download Link</u> or <u>Magnet Link</u> or <u>.torrent File</u>. \n"
...
async def incoming_youtube_dl_f(client, message):
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text(
            "Use This Command As Reply To a <u>Streaming Link</u>. \n"
            f"<b>API Error</b>: {cf_name}"
        )
#playlist
async def g_yt_playlist(client, message):
    ...
    if 'www.youtube.com/playlist' in message.reply_to_message.text:
        ...
        await i_m_sefg.edit_text("Reply to Only <u>YouTube Playlist Link</u>.")
