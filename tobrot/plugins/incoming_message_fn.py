...
async def incoming_purge_message_f(client, message):
    """/purge command"""
    i_m_sefg2 = await message.reply_text("Okay Wait,\nI'm Purging… .. . ⏳", quote=True)
...
async def incoming_message_f(client, message):
    """/leech command"""
    i_m_sefg = await message.reply_text("Okay Wait,\nI'm Processing… .. . ⏳", quote=True)
    is_zip = False
    is_unzip = False
    is_unrar = False
    is_untar = False
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text("Intiating Download… .. . ⇓")
        ...
        await i_m_sefg.edit_text(
            "Use This Command As Reply To a \n<b><i>• Direct Download Link</i></b>\n<b><i>• Magnet Link</i></b>\n<b><i>• .torrent File</i></b>.\n\nTo Upload File(s) on Telegram"
        )
#
async def incoming_gdrive_message_f(client, message):
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text(
            "Use This Command As Reply To a \n<b><i>• Direct Download Link</i></b>\n<b><i>• Magnet Link</i></b>\n<b><i>• .torrent File</i></b>.\n\nTo Upload File(s) on Google Drive."
        )
...
async def incoming_youtube_dl_f(client, message):
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text(
            "Use <code>/stream</code> As Reply To a \n<b><i>• Streaming Link</i></b>.\n\nAnd\nUse <code>/ytpl</code> As Reply To a \n<b><i>• YouTube Playlist Link</i></b>."
        )
#playlist
async def g_yt_playlist(client, message):
    ...
    if 'youtube.com/playlist' in message.reply_to_message.text:
        ...
        await i_m_sefg.edit_text("Reply to Only <b><i>YouTube Playlist Link</i></b>.")
