...
async def check_size_g(client, message):
    ...
    del_it = await message.reply_text("Okay Wait,\nI'm Processing¡­ .. . ?")
...
async def g_clearme(client, message):
    ...
    await message.reply_text("Are You Really Sure ?\nThis Will Delete All Your Downloaded Files From Server Database.", reply_markup=reply_markup, quote=True)
