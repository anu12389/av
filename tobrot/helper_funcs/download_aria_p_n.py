...
async def call_apropriate_function(
    ...
    try:
        ...
        if message_to_send != "":
            ...
            message_to_send = "Sorry But Failed To Upload You Files"
    ...
    try:
        ...
        if not complete:
            if not file.error_message:
                ...
                msg += f"\nSpeed • {file.download_speed_string()} ⬇️║⬆️ {file.upload_speed_string()} "
                ...
                if is_file is None :
                   ...
                   msg += f"\n[ Peer • {file.connections} || Seeder • {file.num_seeders} ]"
